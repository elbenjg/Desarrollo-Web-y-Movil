...
<body style="background-color: #1A41C9; color: white;">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" style= "background-color: #07176E !important;">
                            <li><a class=" dropdown-item" href="contactoed.php" style="color: #FF0033;"> Correo Educacional</a></li>
    ...
    <header class="container mt-5 text-center">
        ...
        <h4>
            <small>Correo: <a href="mailto: b.arayagonzlez@uandresbello.edu" class="fw-bold" style="color: #FF0033;">b.arayagonzlez@uandresbello.edu</a></small>
        </h4>
    </header>
