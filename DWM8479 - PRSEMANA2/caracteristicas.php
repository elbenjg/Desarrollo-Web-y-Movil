...
<body style="background-color: #1A41C9; color: white;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="caracteristicas.php" style="color: #FF0033 !important;">Características</a>
                    </li>
    ...
    <header class="container mt-5 text-center">
        <h1 class="display-4 fw-bold">Características de la tarea</h1>
        <p class="lead" style="color: #61F2F5;">Algunas de las caracterísitcas</p>
        <h4><small><p>- Esta página fue creada usando HTML <br> - Se usó como base la herramienta Bootstrap 5 </p></small></h4>
    </header>
